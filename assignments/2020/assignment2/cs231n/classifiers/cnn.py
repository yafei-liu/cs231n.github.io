...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dscores, grads['W3'], grads['b3'] = affine_backward(dout, scores_cache)
        daffine, grads['W2'], grads['b2'] = affine_relu_backward(dscores, affine_cache)
        dconv, grads['W1'], grads['b1'] = conv_relu_pool_backward(daffine, conv_cache)
